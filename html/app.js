...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				if (config.showPlayerID == true) { document.querySelector('#userID').style.display = 'block'; }
				if (config.showzafiro == true) { document.querySelector('#zafiro').style.display = 'block'; }
